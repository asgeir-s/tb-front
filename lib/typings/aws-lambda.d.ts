    ...
    export interface Context {
         ...
         * @param result provides the result of a successful function execution. The result provided must be JSON.stringify compatible. If an error is provided, this parameter is expected to be null.
         */
         ...
         *
         * @param result is optional parameter and it can be used to provide the result of the function execution. Must be JSON.stringify compatible.
         */
         ...
         * If the error value is non-null, the method will set the response body to the string representation of error and also write corresponding logs to CloudWatch. 
         *
